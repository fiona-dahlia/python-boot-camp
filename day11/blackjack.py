...
def calculate_score(cards):
    ...
    elif card_sum > 21 and 11 in cards:
        cards.remove(11)
        cards.append(1)
        return sum(cards)
    else:
...
def compare(p_user_score, p_computer_score):
    if p_computer_score == p_user_score:
        print("It's a draw.")
    elif p_computer_score == 0:
        print("You lost.")
    elif p_user_score == 0:
        print("You win!")
    elif p_user_score > 21:
        print("You lose.")
    elif p_computer_score > 21:
        print("You win!")
    else:
        if p_user_score > p_computer_score:
            print("You win")
        else:
            print("You lose.")
...
def game():
    ...
    while not is_game_over:
        ...
        # or if the user's score is over 21,
        # then the game ends.
